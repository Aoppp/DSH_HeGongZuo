...
export type ModuleId = 'management-cockpit' | 'overview' | 'work-assistant' | 'employee-data' | 'employee-agent' | 'employee-attendance' | 'employee-reports' | 'finance-management' | 'project-management' | 'developer-console'
