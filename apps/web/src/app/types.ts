...
export type ModuleId = 'management-cockpit' | 'overview' | 'main-assistant' | 'employee-data' | 'employee-agent' | 'employee-attendance' | 'employee-reports' | 'recruitment-management' | 'meeting-records' | 'finance-management' | 'project-management' | 'developer-console'
