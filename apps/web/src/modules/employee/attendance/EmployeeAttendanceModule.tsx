import { AlertTriangle, CalendarDays, CheckCircle2, Clock3, LoaderCircle, RefreshCw } from 'lucide-react'
...
export function EmployeeAttendanceModule(_props: ModuleProps) {
  ...
  return <div className="employee-work-records module-page">
    ...
    {loading && !snapshot ? <div className="work-records-loading"><LoaderCircle className="spin" size={22} />正在加载考勤数据…</div> : snapshot && <>
