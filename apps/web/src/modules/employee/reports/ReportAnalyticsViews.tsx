...
export function DashboardView({ date, revision, onOpenDate }: { readonly date: string; readonly revision: number; readonly onOpenDate: (date: string) => void }) {
