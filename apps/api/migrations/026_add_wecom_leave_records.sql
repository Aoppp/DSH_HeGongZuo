DO $$
BEGIN
  IF to_regclass('employee_wecom_leaves') IS NULL THEN
    ...
    CREATE INDEX IF NOT EXISTS employee_wecom_leave_records_employee_time_idx ON employee_wecom_leave_records (employee_id, starts_at, ends_at);
  END IF;
END $$;
