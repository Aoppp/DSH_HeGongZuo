...
export type ModuleId = 'management-cockpit' | 'overview' | 'work-assistant' | 'employee-data' | 'employee-agent' | 'employee-work-records' | 'finance-management' | 'project-management' | 'developer-console'
