// 员工管理 / 数据页面编排。
import { ArrowLeft, CheckCircle2, Eye, Network, RefreshCw, Settings2 } from 'lucide-react'
...
export function EmployeeDataManagement({ backLabel = '返回员工查询', onBack }: EmployeeDataManagementProps) {
  ...
  return <div className="employee-data module-page">
    {management.successMessage && <div className="employee-data__success" role="status"><CheckCircle2 size={18} />{management.successMessage}</div>}
